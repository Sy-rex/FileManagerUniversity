...
При запуске приложения отображается главное меню с различными опциями для работы с файлами и системой.
...
Раздел "Работа с файлами" предоставляет полный набор операций для управления файлами.
...
![Список файлов](media/menu_with_files.jpeg)

Просмотр всех файлов в выбранной директории с подробной информацией.

### Все файлы в директориях

![Все файлы](media/all_files_in_directories.jpeg)

Полный обзор всех файлов пользователя, организованных по директориям.
...
### 🕵️ Защита от XXE-атак

Блокировка внешних сущностей и DTD при обработке XML:

![XXE-атака блокирована](media/xxe_attack.jpeg)

- ✅ Отключение поддержки внешних сущностей
- ✅ Отключение DTD
- ✅ Ограничение глубины вложенности (100 уровней)

### 🎭 Защита от XML-атак (Billion Laughs)

![XML-атака блокирована](media/xml_attack.jpeg)
